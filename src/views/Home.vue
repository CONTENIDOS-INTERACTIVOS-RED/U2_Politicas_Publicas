        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad <b>El Estado y las políticas públicas</b>, examina las nociones claves de gobernabilidad y gobernanza, como fundamentos para comprender el desempeño estatal. Se analiza la evolución teórica y práctica de ambos conceptos, su relación con la implementación de políticas públicas y la necesidad de fortalecer estructuras institucionales. A través de estudios de caso y estrategias de mejora, se promueve una mirada ética, crítica y participativa, sobre la gestión pública. La unidad ofrece herramientas analíticas para interpretar la acción estatal y formular políticas más eficaces, inclusivas y sostenibles.
